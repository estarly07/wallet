...
class GetDistributionsOfMoneyUseCase @Inject constructor(
    private val  distributionOfMoneyRepository: DistributionOfMoneyRepository
) {
    suspend operator fun invoke(): Flow<List<DistributionOfMoneyModel>?> = distributionOfMoneyRepository.distributions
}